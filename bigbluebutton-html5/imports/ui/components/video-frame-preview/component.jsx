...
class VideoFramePreview extends Component {
...
VideoFramePreview.propTypes = propTypes;
VideoFramePreview.defaultProps = defaultProps;

export default injectIntl(VideoFramePreview);
