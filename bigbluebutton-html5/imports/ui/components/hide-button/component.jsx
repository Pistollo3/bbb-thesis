...
const HideButtonComponent = ({
  ...
  return (
    <div className={wrapperClassName}>
      <Button
        color="default"
        icon={!isFullscreen ? 'cross' : 'exit_fullscreen'}
        size="sm"
        onClick={reducer}
...
HideButtonComponent.propTypes = propTypes;
HideButtonComponent.defaultProps = defaultProps;

export default injectIntl(HideButtonComponent);
